...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className="w-64 bg-indigo-800 text-white min-h-screen p-4 relative">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Class {activity.class} • {activity.time}
                    </p>
                  </div>
                  <div className="ml-auto text-gray-500 text-sm">Just now</div>
                </div>
              ))}
            </div>
          </div>
